																					...
																					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
																						...
																						<g:if
																							...
																							<g:if
																								...
																								<td><g:link action="makePayment"
																										resource="${formDetailInstance}">
																										<span class="label label-sm label-danger"><b>Payment
																												Pending</b></span>
																									</g:link></td>
																							</g:if>
																		...
																		<div class="modal-content">
																			<div class="modal-header">
																				...
																				<h4 class="modal-title"
																					...
																					of the Teaching Applications / ಬೋಧನಾ ಅರ್ಜಿಗಳ
																					ವಿವರಗಳು</h4>
																			</div>
																		...
																		<div class="modal-content">
																			<div class="modal-header">
																				<button type="button" class="close"
																					data-dismiss="modal">&times;</button>
																				<h4 class="modal-title"
																					style="text-align: center; font-weight: 900; color: red;">Details of the Teaching Applications / ಬೋಧನಾ ಅರ್ಜಿಗಳ ವಿವರಗಳು</h4>
																			</div>
																			<div class="modal-body">
